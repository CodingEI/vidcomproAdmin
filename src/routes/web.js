...
import aviatorController from "../controllers/aviatorController.js";

let router = express.Router();
const upload = multer({ storage: multer.memoryStorage() });

const initWebRouter = (app) => {
  router.get("/dailyInterestTest", userController.distributeDailyInterest);
  router.get(
    "/distributeMonthlyLevelIncome",
    userController.distributeMonthlyLevelIncome,
  );
  // router.get(
  //   "/dailyExtraSalaryTest",
  //   userController.distributeExtraSalaryDaily,
  // );
  // page account
  router.get(
    "/distributeMonthlyLevelIncome",
  ...
  router.get(
    "/previousQueries",
    middlewareController,
    homeController.previousQueriesPage,
  );
  ...
  router.get(
    "/claimAttendance",
    middlewareController,
    homeController.claimAttendancePage,
  );
  router.get(
    "/attendance/record",
    middlewareController,
  ...
  router.post(
    "/api/activity/dailyAttendanceBonus/claim",
    middlewareController,
    userController.claimDailyAttendanceBonus,
  );
  router.get(
    "/first_deposit_bonus",
    middlewareController,
  ...
  router.get(
    "/api/webapi/aviator/getCurrentBets",
    middlewareController,
    aviatorController.getCurrentlyBet,
  );
  router.get(
    "/api/webapi/aviator/getNewGeneratedGameId",
    middlewareController,
    aviatorController.getNewGeneratedGameId,
  );
  router.get(
    "/api/webapi/aviator/increamentor",
    middlewareController,
    aviatorController.increamentor,
  );
  router.get(
    "/api/webapi/aviator/myBetsHistory",
    middlewareController,
    aviatorController.myBetsHistory,
  );
  router.post(
    "/api/webapi/aviator/add_bet",
    middlewareController,
    aviatorController.betNow,
  );
  router.post(
    "/api/webapi/aviator/gameover",
    middlewareController,
    aviatorController.gameover,
  );
  router.get(
    "/api/webapi/aviator/cashout",
    middlewareController,
    aviatorController.cashout,
  );
  ...
  router.post(
    ...
    middlewareController,
    upload.fields([{ name: "upi_image", maxCount: 1 }]),
    withdrawalController.addBankCard,
  ); // register
  router.post(
    "/api/webapi/withdraw/add_usdt_address",
    middlewareController,
    upload.fields([{ name: "usdt_image", maxCount: 1 }]),
  ...
  router.post(
    "/api/withdrawable_money_transfer",
    middlewareController,
    paymentController.withdrawableMoneyTransfer,
  ); // register
  router.post(
    "/api/webapi/transfer",
    middlewareController,
  ...
  router.get(
    ...
    adminController.middlewareAdminController,
    adminController.userSupportPage,
  ); // insert
  router.get(
    "/api/webapi/help",
    middlewareController,
    helpController.getAllSubmitedQuery,
  ); // insert
  router.post(
    "/api/webapi/help/respond",
    middlewareController,
    helpController.respondQuery,
  ); // insert
  router.get(
    "/api/webapi/help/getUserQueries",
    middlewareController,
    helpController.getUserQueries,
  ); // insert
  router.post(
    "/api/webapi/help",
    middlewareController,
    upload.single("file"),
    helpController.submitQuery,
  ); // insert
  ...
  router.post(
    "/admin/manager/deleteBanner",
    adminController.middlewareAdminController,
    adminController.deleteBanner,
  );
  router.get(
    "/admin/manager/getBannerById/:id",
    adminController.middlewareAdminController,
    adminController.getBannerById,
  );
  router.get(
    "/admin/manager/banners",
    adminController.middlewareAdminController,
  ...
  router.post("/manager/deleteQrCodes", adminController.deleteQrCodes);
  router.post("/manager/updateUpiUsdtIds", adminController.updateUpiUsdtIds);
  router.post(
    "/manager/editAndupdateUpiUsdtIds",
    adminController.editAndupdateUpiUsdtIds,
  );
  router.post("/manager/deleteUpiUsdtId", adminController.deleteUpiUsdtId);

  //
  router.post(
    "/manager/uploadQrCodes",
    upload.single("image"),
    adminController.uploadQrCodes,
  );
  router.post(
    "/manager/updateQrCodes",
    upload.single("image"),
    adminController.updateQrCodes,
  );
  router.get(
  ...
  router.post(
    "/admin/manager/settings/updateFinancialSettings",
    adminController.middlewareAdminController,
    adminController.updateFinancialSettings,
  ); // get info account
  router.post(
    "/admin/manager/settings/updateReferralIncomeByLevel",
    adminController.middlewareAdminController,
    adminController.updateReferralIncomeByLevel,
  ); // get info account
  router.post(
    "/admin/manager/settings/updateFirstRechargeSettingsByLevel",
    adminController.middlewareAdminController,
    adminController.updateFirstRechargeSettingsByLevel,
  ); // get
  router.post(
  ...
  router.get(
    "/admin/manager/withdraw/export",
    adminController.middlewareAdminController,
    adminController.exportWithdrawList,
  ); // get info account
  ...
  // router.get("/api/webapi/salary-test", userController.distributeSalaries);
  // router.get(
  //   "/api/webapi/teambonus-test",
  //   userController.distributeTeamBonuses,
  // );
  router.get("/api/webapi/interest", userController.distributeDailyInterest);
  router.get(
  ...
  router.post(
    "/api/webapi/admin/updateMemberWallet",
    adminController.middlewareAdminController,
    adminController.updateMemberWallet,
  );

  router.post(
    "/api/webapi/admin/addMemberWallet",
    adminController.middlewareAdminController,
    adminController.addMemberWallet,
  );
  router.post(
    "/api/webapi/admin/removeMemberWallet",
    adminController.middlewareAdminController,
    adminController.removeMemberWallet,
  );
  //
  router.post(
    "/api/webapi/admin/addMemberWithdrawableWallet",
    adminController.middlewareAdminController,
    adminController.addMemberWithdrawableWallet,
  );
  router.post(
    "/api/webapi/admin/removeMemberWithdrawableWallet",
    adminController.middlewareAdminController,
    adminController.removeMemberWithdrawableWallet,
  );
  ...
  router.post(
    "/api/webapi/admin/updateUserBank/:phone",
    upload.fields([
      { name: "upiImage", maxCount: 1 },
      { name: "usdtImage", maxCount: 1 },
    ]),
    adminController.middlewareAdminController,
    adminController.updateUserBank,
  );
  router.post(
  ...
  router.post(
    "/api/webapi/admin/restriction",
    adminController.middlewareAdminController,
    adminController.restriction,
  ); // get info account
  ...
  // webhooks
  router.post(`/webhook/recharge`, webhookController.updateRecharge);
